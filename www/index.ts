import { Generator, Board } from "mapgen";
...
const app = new (class {
  ...
  constructor() {
    ...
    this.widthInput = document.getElementById(
      "width-input"
    ) as HTMLInputElement;
    this.heightInput = document.getElementById(
      "height-input"
    ) as HTMLInputElement;
    ...
    this.paintButton = document.getElementById(
      "paint-button"
    ...
    this.downloadJSONButton = document.getElementById(
      "download-json-button"
    ) as HTMLButtonElement;
    this.downloadJSONButton.addEventListener(
      "click",
      this.onDownloadJSON.bind(this)
    );

    this.downloadPNGButton = document.getElementById(
      "download-png-button"
    ) as HTMLButtonElement;
    this.downloadPNGButton.addEventListener(
      "click",
      this.onDownloadPNG.bind(this)
    );
  }
  ...
  private onDownloadJSON(_: Event) {
    ...
    const blob = new Blob([this.currentBoard.as_json()!], {
