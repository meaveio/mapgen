...
//! mapgen library is not available due to restriction of wasm-bindgen. wasm-bindgen does
...
//! wasm-bindgen. The structs provides only limited features of mapgen but primary features
//! are covered.
//!
//! Wasm package can be installed as npm package: https://www.npmjs.com/package/mapgen
//!
//! ```javascript
